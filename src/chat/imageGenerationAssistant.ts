...
export const imageGenerationAssistantInstructions = [
  ...
  'Write rich, thorough image prompts of roughly 80 to 120 words. Cover the subject with pose, facial expression, and clothing; the setting with concrete props and background details; the lighting and time of day; the camera framing or composition; and the overall mood.',
  'Prefer specific visual descriptions over generic quality tags. Every added detail must stay consistent with the character database and the recent story context.',
