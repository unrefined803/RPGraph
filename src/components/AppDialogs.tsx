...
const customNodePromptSuggestions = [
  ...
  },
  {
    ...
    prompt: [
      'Build a Custom Node that generates a short npc reaction from character action and mood.',
  ...
  {
    title: 'Relationship Delta Analyzer',
    prompt: [
      'Build a Custom Node that analyzes how a roleplay exchange changes relationship stats.',
  ...
  {
    title: 'Tone Rewriter Gate',
    prompt: [
      'Build a Custom Node that rewrites incoming roleplay text depending on a selected tone.',
  ...
  {
    title: 'Memory Summary Compressor',
    prompt: [
      'Build a Custom Node that compresses long roleplay history into concise memory bullets.',
  ...
  {
    title: 'Character Stat Updater',
    prompt: [
      'Build a Custom Node that updates character stats from the latest scene.',
